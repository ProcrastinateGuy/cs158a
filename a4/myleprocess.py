...
class LeaderNode:
    def __init__(self, config_path= "./a4/config.txt"):
        ...
        try:
            ...
            print("no config file provided, default to \'a4/config.txt\'")
            config_path= "./a4/config.txt"
        ...
        self.log_file = open('./a4/log1.txt', 'a')
